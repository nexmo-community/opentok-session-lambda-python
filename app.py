...
def session():
    ...
    # otsession = opentok.create_session(location=u'12.34.56.78', media_mode=MediaModes.routed, archive_mode=ArchiveModes.always)
    otsession = opentok.create_session(**args_dict)
